...
$sql = "INSERT INTO exeat ( matric_no, full_name, student_id, destination, destination_address,  support_no, support_name, parent_no, exeat_date, date_of_depature, arrival_date, reason ) VALUES('$matric_no','$full_name', '$id','$destination','$destination_address','$support_name','$support_no','$parent_no','$exeat_date','$Departure_Date','$Arrival_date','$Reason_for_exeat')";
