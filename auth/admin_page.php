<HTML>
  <HEAD>
  <title>Admin | Crawford  Exeat</title>
</HTML>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="" class="mr-2" alt=""/>Crawford Exeat</a>
...
<table class="table table-striped table-hover table-responsive custom main" >
<thead>
  <tr>
...
<?php
  ...
  if($result){
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      $exeat_details =  $row['exeat_id'];
      $_SESSION["exeat_details"] = $exeat_details;
